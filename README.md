...
| 平台 | 当前版本 | 发布形式 | 说明 |
|---|---:|---|---|
| Windows x64 | 2.0.3 | NSIS 安装包、免安装 ZIP | 支持 Edge、Chrome 和按需下载的 Chromium |
| macOS Apple Silicon | 2.0.3 | DMG | 未签名、未公证，首次打开需在系统设置中确认 |
| Android 7.0 及以上 | 2.0.3（versionCode 14） | APK | 使用系统 WebView，支持系统文件保存和应用内更新检查 |
