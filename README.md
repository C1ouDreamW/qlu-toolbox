...
1. 前往 [Releases](https://github.com/C1ouDreamW/qlu-toolbox/releases) 下载最新版本：
   ...
   - Apple Silicon Mac：下载 `QLUToolbox_v*_arm64.dmg`，打开后将 `QLUToolbox.app` 拖入“应用程序”。当前 DMG 未使用 Apple 开发者证书签名或公证，首次启动可能被 macOS 拦截；请在“系统设置 → 隐私与安全性”中确认打开。不要使用来源不明的第三方包。
...
- Windows 任务记录、日志和浏览器登录状态：`%LOCALAPPDATA%\QLUToolbox`
- macOS 设置、任务记录、日志和浏览器登录状态：`~/Library/Application Support/QLUToolbox`
